...
namespace VideoBookApplication.common.enums
{
    public class ApplicationErrorType
    {
        ...
        public static ApplicationErrorType READ_REPORT_ERROR = new ApplicationErrorType(25, "Errore Lettura Dati per Report");
        ...
        public static ApplicationErrorType NO_CATEGORY_WARN = new ApplicationErrorType(1009, "Nessuna Categoria Trovata");

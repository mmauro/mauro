...
{
    public partial class EditPositionPanel : Panel
    {
        ...
        public EditPositionPanel(ref GlobalApplicationObject globalObject, LibraryActivityWindow parent)
        {
            InitializeComponent();
            this.parent = parent;
        ...
        private void initPanel()
        {
            ...
            //Title
            TitlePanel titlePanel = new TitlePanel("Modifica Posizione", this);
            ...
            toolTip1.SetToolTip(buttonOk, "Modifica Posizione");
        ...
        private ApplicationErrorType refreshData()
        {
            ...
            try
            {
                ...
                List<PositionModel> tmpCModel = posControl.getAllPosition(false);
                if (tmpCModel != null && tmpCModel.Count > 0)
                {
                    listItemsCat = new List<ItemCombo>();
                    foreach (PositionModel mc in tmpCModel)
                    {

...
namespace VideoBookApplication.common.view
{
    public partial class DeleteMenuLibrary : Panel
    {
        ...
        private void initPanel()
        {
            ...
            //toolTip
            toolTip1.SetToolTip(buttonDelBook, "Nuovi Libri");
            toolTip1.SetToolTip(buttonDelAuthor, "Nuovo Autore");
            toolTip1.SetToolTip(buttonDelPosition, "Nuova Posizione");
            toolTip1.SetToolTip(buttonDelCategory, "Nuova Categoria");
        }
